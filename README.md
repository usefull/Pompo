...
Method names for creating objects are formed as follows: _create___{SERVICENAME}_. _SERVICENAME_ is either an alias defined in the _PompoAlias_ attribute or a real class name with namespace.
